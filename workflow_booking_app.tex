...
\begin{tikzpicture}[remember picture,font=\small]
  ...
  \node[data,text width=4.7cm] (evidence) at (7.0,-0.3) {\textbf{Một luồng demo chung}\\[3pt]
    Tìm phòng $\rightarrow$ đặt $\rightarrow$ duyệt $\rightarrow$ tiếp cận\\$\rightarrow$ sử dụng $\rightarrow$ check-out $\rightarrow$ đóng booking};
...
\begin{tikzpicture}[font=\small]
  ...
  \node[stage] (search) at (5.6,3.7)
    {\textbf{2. Tra cứu}\\[3pt]Thời gian, cơ sở\\Sức chứa, loại phòng\\Thiết bị cần dùng};
  \node[stage,fill=mobileblue] (request) at (9.5,3.7)
    {\textbf{3. Tạo yêu cầu}\\[3pt]Chọn phòng\\Mục đích, số người\\Đơn vị và liên hệ};
